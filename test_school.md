...
| `school_lesson_recordings` | Meniu **Įrašai** → `/school/recordings` |
...
- [ ] Sąrašas su Drive nuoroda, data, trukmė, grupė.
- [ ] Seed: `QA Matematika 2026-08-24.mp4`.
- [ ] Extra-lessons accept: **atskiras** įrašų checkbox (ne tas pats kaip 14 d.). Be flag — klausimo nėra.
...
| Nėra Grupės / Įrašai | flag’ai; perseedinti legal/extra QA |
