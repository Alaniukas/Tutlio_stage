-- TEMPORARY baseline for a fresh TEST project.
-- Generated from supabase/schema.sql; deleted immediately after push.
...
-- Supabase installs uuid-ossp into the `extensions` schema, which is not on
-- the migration search_path, so uuid_generate_v4() cannot resolve unqualified.
...
-- =====================================================
-- Migration: 20260703120000_session_reschedule_reason
-- =====================================================
...
-- =====================================================
-- Migration: 20260703120100_student_reschedule_disable_flag
-- =====================================================
...
-- =====================================================
-- Migration: 20260703130000_sessions_student_update_hardening
-- =====================================================
