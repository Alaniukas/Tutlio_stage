-- Student / parent-visible profile rows: include org tied to student record so UI can hide
-- school-specific payment UX without querying organizations directly (RLS).
