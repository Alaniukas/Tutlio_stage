-- Allow linked parents to read the same enriched student rows as linked students use in get_student_profiles.
-- SECURITY: caller identity must match p_user_id.
