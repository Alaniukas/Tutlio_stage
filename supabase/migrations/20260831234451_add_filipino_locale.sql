-- Allow Filipino UI preferences for tutors and tutoring businesses.
...
ALTER TABLE public.profiles
  ...
  CHECK (preferred_locale IS NULL OR preferred_locale IN ('lt', 'en', 'pl', 'lv', 'ee', 'fr', 'es', 'de', 'se', 'dk', 'fi', 'no', 'nl', 'it', 'pt', 'ro', 'cs', 'el', 'hu', 'bg', 'hr', 'sk', 'sl', 'hi', 'ko', 'ja', 'id', 'ar', 'pt-br', 'es-mx', 'fil'));
