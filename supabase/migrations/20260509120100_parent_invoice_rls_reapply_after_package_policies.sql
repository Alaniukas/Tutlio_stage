-- Re-apply safe parent invoice RLS after `20260508120200_parent_invoices_packages_storage.sql`:
-- that migration runs later than `20260503140000_*` and replaced policies with the recursive version.
-- This file is idempotent (same function + policies as 20260503140000) and must run last among these.
