-- Let logged-in user find a student row by email when that row is either already linked to them or unlinked.
-- Used by Login to avoid creating a tutor profile for someone who is actually a student.
