...
const DEMO_REQUESTS: SupportRequest[] = [
  {
    ...
    attachments: [],
    coding_agent_prompt: 'You are an AI coding agent working in the Tutlio repository. Investigate and resolve support report SUP-8CB31CD5.\n\nReproduce the blank invoice PDF, identify the verified root cause, implement a regression-safe fix, and run the relevant tests and production build.',
  ...
  },
  {
    ...
    transcript: [],
    attachments: [],
    coding_agent_prompt: 'You are an AI coding agent working in the Tutlio repository. Implement support request SUP-971BF5D4.\n\nDesign a parent rescheduling flow that preserves existing cancellation rules, notifies both parties, and includes regression coverage.',
    completion_notified_at: null,
    completion_notification_email_id: null,
    status: 'planned',
    priority: 'medium',
