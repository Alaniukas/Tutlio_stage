...
const COPY: Record<'en' | 'lt' | 'pl', Copy> = {
  en: {
    ...
    readySuggestion: 'Thank you - I have enough information. Type “send it” when you are ready. The team will act on it as soon as possible, and we will email you when the bug is fixed or the feature is implemented. I will not send anything without your confirmation.',
    manualSendSuggestion: 'Your report is structured and ready for manual review. Tell me “send it” to notify the team. They will act on it as soon as possible, and we will email you when the bug is fixed or the feature is implemented.',
  ...
  lt: {
    ...
    readySuggestion: 'Ačiū - informacijos jau pakanka. Kai būsite pasiruošę, parašykite „siųsti“. Komanda imsis darbo kaip įmanoma greičiau, o ištaisius klaidą arba įdiegus funkciją gausite el. laišką. Be jūsų patvirtinimo nieko nesiųsiu.',
    manualSendSuggestion: 'Pranešimas susistemintas ir paruoštas rankinei peržiūrai. Parašykite „siųsti“, kad informuočiau komandą. Ji imsis darbo kaip įmanoma greičiau, o ištaisius klaidą arba įdiegus funkciją gausite el. laišką.',
  ...
  pl: {
    ...
    readySuggestion: 'Dziękuję - mam już wystarczająco dużo informacji. Gdy będziesz gotowy, wpisz „wyślij”. Zespół zajmie się zgłoszeniem tak szybko, jak to możliwe, a po naprawieniu błędu lub wdrożeniu funkcji otrzymasz e-mail. Niczego nie wyślę bez Twojego potwierdzenia.',
    manualSendSuggestion: 'Zgłoszenie jest uporządkowane i gotowe do ręcznego sprawdzenia. Napisz „wyślij”, aby powiadomić zespół. Zajmie się nim tak szybko, jak to możliwe, a po naprawieniu błędu lub wdrożeniu funkcji otrzymasz e-mail.',
