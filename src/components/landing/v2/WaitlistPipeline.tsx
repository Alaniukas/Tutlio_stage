...
type Entry = { name: string; subject: string; whenKey: string };
...
const COLUMNS: { key: string; titleKey: string; dot: string; entries: Entry[]; done?: boolean }[] = [
  {
    ...
    dot: 'bg-amber-400',
    entries: [
      { name: 'Gabija P.', subject: 'landing.v2.wlSubjMath', whenKey: 'landing.v2.wlJustNow' },
      { name: 'Tomas V.', subject: 'landing.v2.wlSubjEng', whenKey: 'landing.v2.wlAgo1h' },
      { name: 'Kotryna S.', subject: 'landing.v2.wlSubjPhys', whenKey: 'landing.v2.wlAgo2h' },
    ],
  },
  {
    key: 'offered',
    ...
    dot: 'bg-blue-400',
    entries: [{ name: 'Ieva M.', subject: 'landing.v2.wlSubjMath', whenKey: 'landing.v2.wlAgo2h' }],
  },
  {
    key: 'booked',
    ...
    entries: [
      { name: 'Lukas R.', subject: 'landing.v2.wlSubjPhys', whenKey: 'landing.v2.wlAgo2h' },
      { name: 'Austėja D.', subject: 'landing.v2.wlSubjEng', whenKey: 'landing.v2.wlAgo3h' },
      { name: 'Domas N.', subject: 'landing.v2.wlSubjMath', whenKey: 'landing.v2.wlAgo3h' },
    ],
  },
];
